...
class KakaoMapViewController : UIViewController, MapControllerDelegate {
  ...
  override func viewWillAppear(_ animated: Bool) {
      ...
      if mapController?.isEngineActive == false {
          mapController?.activateEngine()
          print("Engine activated in viewWillAppear")
      }
  }
  ...
  override func viewWillDisappear(_ animated: Bool) {
      ...
      if mapController?.isEngineActive == true {
          mapController?.pauseEngine()
          print("Engine paused in viewWillDisappear")
      }
  }
  ...
  override func viewDidDisappear(_ animated: Bool) {
      ...
      // Reset engine only if necessary
      if _appear == false {
          print("Reset engine in viewDidDisappear")
          // mapController?.resetEngine() - 필요 시 호출
      }
